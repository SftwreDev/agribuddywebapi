...
def openmeteo_datasets():
    date_today = dt.date.today()
    five_days_ago = date_today - dt.timedelta(days=5)
    print(five_days_ago)
    url = f"https://api.open-meteo.com/v1/forecast?latitude=13.85&longitude=121.20&hourly=temperature_2m,relativehumidity_2m,dewpoint_2m,windspeed_10m&current_weather=true&past_days=5&forecast_days=1&timezone=Asia%2FSingapore"
    print(url)
